...
sys.path.append("/home/okoc/vision/Vision_Experiments/sebastian/")
import numpy as np
...
indices_ball = fball.find_balls(img_path="/home/okoc/Desktop/robot/ping/black/",
                                ranges=[750, 7380],
                                cams=[0, 1])
...
for i in range(len(moving_frames)):
    ...
    x_ball_img = []
    for j in range(3):
        x_ball_img.append(np.interp(x, xp=t_move, yp=x_ball[j, :]))
