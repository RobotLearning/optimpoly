...
**** TODO Adjust timing of the motion
**** TODO Train on different examples in the dataset
...
REPS, PILCO, POWER, etc.
**** TODO Model free or model based RL?
*** TODO How many basis functions to use in DMPs?
*** TODO How many rollouts per policy update etc.
** TODO Can we cast it as an optimal control problem?
*** TODO Can we learn a model of the ball takeoff?
Possibly from model-free RL examples, one could learn such a model.
