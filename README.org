...
*** DONE Tune the movement primitives
...
*** IN-PROGRESS Learning approach
The options are model-free, hybrid, model-based RL and Bayesian
Optimization (BO).
...
**** TODO How to apply model-free RL
