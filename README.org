...
** IN-PROGRESS Cast it as an optimal control problem
...
Instead of running an extern triangulation server, I can do the
...
**** WAITING Questions about ball interface
...
***** TODO No need to send zeros if ball is not detected
This will obviously pose a problem online 
...
***** TODO Does serving closer to the table help detection?
