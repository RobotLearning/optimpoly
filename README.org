...
*** TODO Compile vision code in vision computer
...
*** TODO Test vision code with a flying ball
**** TODO Test in laptop
Fix python script, connecting to localhost.
**** TODO Test in robot computer
