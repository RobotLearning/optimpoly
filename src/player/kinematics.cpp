 ...
 * @file kinematics.cpp
 *
 * @brief Kinematics functions are stored here as C++ functions
 * to be called from Player class.
 *
...
static const double ZHR =
    0.505; //! length of upper arm until 4.5cm before elbow link
 ...
 *
 */
static void revolute_jac_col(const vec3 &p, const vec3 &pi, const vec3 &zi,
                             vec6 &col);
 ...
 *
 */
static void kinematics(const vec7 &q, mat &Xlink, mat &Xorigin, mat &Xaxis,
                       cube &Amats);
...
static void kinematics(const vec7 &q, mat &Xlink, mat &Xorigin, mat &Xaxis,
  ...
  Ai07(2, 2) = Ai06(2, 0);
  Ai07(2, 3) = Ai06(2, 3);
  Ai08(0, 0) = Ai07(0, 0) * Hi78(0, 0) + Ai07(0, 1) * Hi78(1, 0) +
               Ai07(0, 2) * Hi78(2, 0);
  Ai08(0, 1) = Ai07(0, 0) * Hi78(0, 1) + Ai07(0, 1) * Hi78(1, 1) +
               Ai07(0, 2) * Hi78(2, 1);
  Ai08(0, 2) = Ai07(0, 0) * Hi78(0, 2) + Ai07(0, 1) * Hi78(1, 2) +
               Ai07(0, 2) * Hi78(2, 2);
  Ai08(0, 3) = Ai07(0, 3) + Ai07(0, 0) * Hi78(0, 3) + Ai07(0, 1) * Hi78(1, 3) +
               Ai07(0, 2) * Hi78(2, 3);
  Ai08(1, 0) = Ai07(1, 0) * Hi78(0, 0) + Ai07(1, 1) * Hi78(1, 0) +
               Ai07(1, 2) * Hi78(2, 0);
  Ai08(1, 1) = Ai07(1, 0) * Hi78(0, 1) + Ai07(1, 1) * Hi78(1, 1) +
               Ai07(1, 2) * Hi78(2, 1);
  Ai08(1, 2) = Ai07(1, 0) * Hi78(0, 2) + Ai07(1, 1) * Hi78(1, 2) +
               Ai07(1, 2) * Hi78(2, 2);
  Ai08(1, 3) = Ai07(1, 3) + Ai07(1, 0) * Hi78(0, 3) + Ai07(1, 1) * Hi78(1, 3) +
               Ai07(1, 2) * Hi78(2, 3);
  Ai08(2, 0) = Ai07(2, 0) * Hi78(0, 0) + Ai07(2, 1) * Hi78(1, 0) +
               Ai07(2, 2) * Hi78(2, 0);
  Ai08(2, 1) = Ai07(2, 0) * Hi78(0, 1) + Ai07(2, 1) * Hi78(1, 1) +
               Ai07(2, 2) * Hi78(2, 1);
  Ai08(2, 2) = Ai07(2, 0) * Hi78(0, 2) + Ai07(2, 1) * Hi78(1, 2) +
               Ai07(2, 2) * Hi78(2, 2);
  Ai08(2, 3) = Ai07(2, 3) + Ai07(2, 0) * Hi78(0, 3) + Ai07(2, 1) * Hi78(1, 3) +
               Ai07(2, 2) * Hi78(2, 3);
